...
class JSInterfaceService: OrderPlaceService {
    ...
    override func handleMessage(method: String, body: NSDictionary, callback: CallbackHandler?) {
        ...
        switch method {
        case "exitwebview":
            exitwebview(body: body, callback: callback);
            break;
        case "canOpenUrl":
    ...
    func exitwebview(body: NSDictionary, callback: CallbackHandler?) {
